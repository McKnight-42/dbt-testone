...
{% macro testone__alter_column_type(relation,column_name,new_column_type) -%}
...
{% macro testone__check_schema_exists(information_schema,schema) -%}
...
{% macro testone__create_schema(relation) -%}
...
{% macro testone__drop_relation(relation) -%}
...
{% macro testone__drop_schema(relation) -%}
...
{% macro testone__get_columns_in_relation(relation) -%}
...
{% macro testone__list_relations_without_caching(schema_relation) -%}
'''creates a table of relations withough using local caching.'''
{% endmacro %}

{% macro testone__list_schemas(database) -%}
...
{% macro testone__rename_relation(from_relation, to_relation) -%}
...
{% macro testone__truncate_relation(relation) -%}
...
{% macro testone__current_timestamp() -%}
